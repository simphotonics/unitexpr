...
def protect(attr_names: Iterable[str] = (),
    ...
    '''
      ...
      - `attr_names`: A tuple containing the names of
        ...
        The default value of `attr_names` is an empty tuple indicating that all
    ...
    def _protect(func):
        ...
        def inner(*args, **kwargs):
            ...
            if (mapped_kwargs['name'] in attr_names or not attr_names) and \
                    hasattr(mapped_kwargs['self'], mapped_kwargs['name']):
